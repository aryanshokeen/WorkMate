...
public class EmployeeController {
    ...
    public String saveEmployee(@ModelAttribute("employee") Employee employee, Principal principal) {
        // Save employee to database with the associated user
        employeeService.saveEmployee(employee, principal.getName());
        return "redirect:/";
    }
    ...
    public String findPaginated(@PathVariable(value = "pageNo") int pageNo, 
        ...
        // Get the paginated employees for the logged-in user
        Page<Employee> page = employeeService.findPaginatedByUser(pageNo, pageSize, sortField, sortDir, userEmail);
        List<Employee> listEmployees = page.getContent();
